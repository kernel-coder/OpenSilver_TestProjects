...
{
    public partial class PatientImmunizationPopup : UserControl
    {
        public PatientImmunizationPopup()
        {
            InitializeComponent();
        }

        private void PatientImmunization_BindingValidationError(object sender, ValidationErrorEventArgs e)
        {
