...
namespace Virtuoso.Core.Converters
{
    ...
    public class VisibilityConverterIsUTEST : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            return Visibility.Visible; // return((TenantSettingsCache.Current.TenantSettingIsUTEST) ? Visibility.Visible : Visibility.Collapsed);
        }
    ...
    public class ShowServiceLineTypeOptionsVisibility : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            bool HasMultiple = true; // TenantSettingsCache.Current.TenantSettingHasMultipleServiceLineTypeOptions;
    ...
    public class RoleAccessBool : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            return null;//  RoleAccessHelper.CheckPermission(parameter.ToString());
        }
    ...
    public class RoleAccessVisibility : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            return null; // RoleAccessHelper.CheckPermission(parameter.ToString()) ? Visibility.Visible : Visibility.Collapsed;
        }
    ...
    public class RoleAccessPlusIntVisibility : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return Visibility.Visible; // RoleAccessHelper.CheckPermission(parameter.ToString()) ? Visibility.Visible : Visibility.Collapsed;
        }
    ...
    public class IsLoggedInUser : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return Visibility.Visible; // selecteduser.Equals(WebContext.Current.User.MemberID) ? Visibility.Visible : Visibility.Collapsed;
        }
