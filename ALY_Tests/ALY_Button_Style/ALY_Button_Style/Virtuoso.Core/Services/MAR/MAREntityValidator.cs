...
namespace Virtuoso.Core.Services.MAR
{
    ...
    {
        readonly bool IsAdmissionMode;
        Virtuoso.Server.Data.Encounter Encounter;
        AdmissionMedicationMAR CurrentAdmissionMedicationMAR;

        internal MAREntityValidator(bool isAdmissionMode, Virtuoso.Server.Data.Encounter encounter, AdmissionMedicationMAR admissionMedicationMAR)
        {
        ...
        // if asWarnings == false - then add ValidationErrors to entity, else return as warnings?
        public bool MARClientValidate(bool asWarnings = false)
        {
            bool success = true;
        ...
        private bool MARClientValidateAdministrationDateTime(AdmissionMedicationMAR admissionMedicationMAR)
        {
            ...
            if (IsAdmissionMode == false && // No SHIFT in Admission Maitenance
                (admissionMedicationMAR.AdministrationDateTimeSort != DateTime.MinValue) &&
            ...
            else if (IsAdmissionMode == false && // No SHIFT in Admission Maitenance
                (admissionMedicationMAR.AdministrationDateTimeSort != DateTime.MinValue) &&
