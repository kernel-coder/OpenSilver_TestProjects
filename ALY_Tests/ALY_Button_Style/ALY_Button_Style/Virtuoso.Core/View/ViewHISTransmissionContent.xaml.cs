...
{
    public partial class ViewHISTransmissionContent : ChildWindow
    {
        public int[] a;
        ...
        public ViewHISTransmissionContent(int[] serviceLineGroupingKeyArray, List<EncounterOasisPotential> eoplist)
        {
            InitializeComponent();
