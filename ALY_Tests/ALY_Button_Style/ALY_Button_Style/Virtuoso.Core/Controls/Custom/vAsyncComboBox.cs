...
#if !OPENSILVER // currently in OpenSilver this workaround is not needed, moreover, selected item might be not displayed,
                // at least for some comboboxes in "FollowUpItemDataTemplate" (/Maintenance/ProcessingRules/1)
