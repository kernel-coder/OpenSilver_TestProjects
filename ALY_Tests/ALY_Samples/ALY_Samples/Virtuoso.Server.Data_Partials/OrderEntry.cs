...
{
    public partial class OrderEntry : IOrderEntry
    {
        private bool _IsReviewed;

        private bool _IsVoided;

        private OrdersTrackingManager _OrderTrackingManager;
        ...
        private string CompletedDateString
        {
            get
            {
                ...
                return string.IsNullOrWhiteSpace(dateTime) ? null : dateTime;
            }
        }

        private OrdersTrackingManager OrderTrackingManager
        {
            get
            {
                // lazy load
                if (_OrderTrackingManager == null)
                {
                    _OrderTrackingManager = new OrdersTrackingManager();
                }

                return _OrderTrackingManager;
            }
        }
        ...
        public string SentText
        {
            get
            {
                if (OrderSent == false || OrderSentDate == null)
                {
                    return null;
                }

                var sentDate = (DateTime)OrderSentDate;
                var dateTime = sentDate.ToShortDateString();
                if (TenantSettingsCache.Current.TenantSetting.UseMilitaryTime)
                {
                    dateTime = dateTime + " " + sentDate.ToString("HHmm");
                }
                else
                {
                    dateTime = dateTime + " " + sentDate.ToShortTimeString();
                }
                ...
                return string.Format("Order marked as sent on {0}  by {1}", dateTime,
        ...
        public bool SentVerifiedGridVisibility
        {
            get
            {
                if (OrdersTracking.Any() == false || OrdersTracking.FirstOrDefault() == null)
                {
                    return false;
                }

                if (OrdersTracking.FirstOrDefault().Status == (int)OrdersTrackingStatus.Void)
                {
                    return false;
                }

                var ret = OrdersTracking.FirstOrDefault().Status >= (int)OrdersTrackingStatus.Sent;
                return ret;
            }
        }

        public bool CanEditOrderSignOrVerified
        {
            get
            {
                ...
                var cutoff = new DateTime(2015, 7, 14);
                return CompletedDate.Value <= cutoff;
                ;
            }
        }

        public bool OrderStatusOKForPOCAddendum => IsOrderStatusOrderEntryReview || IsOrderStatusCompleted ||
                                                   IsOrderStatusSigningPhysicianVerified;

        public bool IsSignedOrderEntrySignature
        {
            get
            {
                ...
                return OrderEntrySignature.First().Signature != null;
            }
        }
        ...
        public bool IsCoSigned
        {
            get
            {
                ...
                return OrderEntryCoSignature.First().Signature != null;
            }
        }
        ...
        public bool IsM1510R1
        {
            get
            {
                ...
                if (string.IsNullOrWhiteSpace(OasisLookbackReferenceCodes))
                {
                    return false;
                }

                var _codes = "|" + OasisLookbackReferenceCodes.ToUpper() + "|";
                return _codes.Contains("|M1510R1|") ? true : false;
            }
        }

        public bool IsM1510R5
        {
            get
            {
                if (HistoryKey != null)
                ...
                var _codes = "|" + OasisLookbackReferenceCodes.ToUpper() + "|";
                return _codes.Contains("|M1510R5|") ? true : false;
            }
        }
        ...
        public bool IsM2004
        {
            get
            {
                ...
                var _codes = "|" + OasisLookbackReferenceCodes.ToUpper() + "|";
                return _codes.Contains("|M2004|") ? true : false;
            }
        }

        public bool IsM2300N
        {
            get
            {
                if (HistoryKey != null)
                ...
                var _codes = "|" + OasisLookbackReferenceCodes.ToUpper() + "|";
                return _codes.Contains("|M2300N|") ? true : false;
            }
        }

        public bool IsM2300Y
        {
            get
            {
                if (HistoryKey != null)
                ...
                var _codes = "|" + OasisLookbackReferenceCodes.ToUpper() + "|";
                return _codes.Contains("|M2300Y|") ? true : false;
            }
        }
        ...
        public bool IsM2400a
        {
            get
            {
                ...
                var _codes = "|" + OasisLookbackReferenceCodes.ToUpper() + "|";
                return _codes.Contains("|M2400A|") ? true : false;
            }
        }
        ...
        public bool IsM2400b
        {
            get
            {
                ...
                var _codes = "|" + OasisLookbackReferenceCodes.ToUpper() + "|";
                return _codes.Contains("|M2400B|") ? true : false;
            }
        }
        ...
        public bool IsM2400c
        {
            get
            {
                ...
                var _codes = "|" + OasisLookbackReferenceCodes.ToUpper() + "|";
                return _codes.Contains("|M2400C|") ? true : false;
            }
        }
        ...
        public bool IsM2400d
        {
            get
            {
                ...
                var _codes = "|" + OasisLookbackReferenceCodes.ToUpper() + "|";
                return _codes.Contains("|M2400D|") ? true : false;
            }
        }
        ...
        public bool IsM2400e
        {
            get
            {
                ...
                var _codes = "|" + OasisLookbackReferenceCodes.ToUpper() + "|";
                return _codes.Contains("|M2400E|") ? true : false;
            }
        }
        ...
        public bool IsM2400f1
        {
            get
            {
                ...
                var _codes = "|" + OasisLookbackReferenceCodes.ToUpper() + "|";
                return _codes.Contains("|M2400F1|") ? true : false;
            }
        }
        ...
        public bool IsM2400f2
        {
            get
            {
                ...
                var _codes = "|" + OasisLookbackReferenceCodes.ToUpper() + "|";
                return _codes.Contains("|M2400F2|") ? true : false;
            }
        }

        public string SignedByThumbnail
        {
            get
            {
                var user = UserCache.Current.GetFullNameWithSuffixFromUserId(CompletedBy);
                return string.Format("Signed by  {0}", string.IsNullOrWhiteSpace(user) ? "?" : user);
            }
        }

        public string OrderDateTimePhysicianThumbnail
        {
            get
            {
                var physician =
                    PhysicianCache.Current.GetPhysicianFullNameInformalWithSuffixFromKey(SigningPhysicianKey);
                var dateTime = CompletedDateString;
                return string.Format("Order Date/Time {0}     {1}",
                    string.IsNullOrWhiteSpace(dateTime) ? "? " : dateTime,
                    string.IsNullOrWhiteSpace(physician) ? "Physician ?" : physician);
            }
        }
        ...
        public bool IsVoidedVisible => IsNew ? false : true;
        ...
        public bool IsSigned
        {
            get
            {
                ...
                if (Encounter.EncounterSignature == null)
                {
                    return false;
                }

                if (Encounter.EncounterSignature.Any() == false)
                {
                    return false;
                }

                return Encounter.EncounterSignature.First().Signature != null;
            }
        }

        partial void OnOrderStatusChanged()
        {
            // Used when opening a 'Sent' InterimOrder from Orders or Documentation tab in an admission
            InitializeVerifiedSignedBinding();
        }

        private void InitializeVerifiedSignedBinding()
        {
            if (OrderStatus == (int)OrderStatusType.SigningPhysicianVerified)
            {
                OrderVerifiedSigned = true;
            }
        }
        ...
        public bool CompletedDateBetweenDates(DateTime startDate, DateTime endDate)
        {
            if (CompletedDate == null)
            {
                return false;
            ...
            var date = ((DateTimeOffset)CompletedDate).Date;
            if (date < startDate)
            {
                return false;
            }
        ...
        partial void OnOrderVerifiedSignedChanged()
        {
            if (OrderVerifiedSigned)
            {
                /* An order is 'signed' when the SigningPhysicianVerifiedDate.HasValue,
                 *                               SigningPhysicianVerifiedBy.HasValue,
                 *                               OrderVerifiedSigned == true,
                 *                               OrderVerifiedSignedDate.HasValue
                 *                               this.OrdersTracking.Status == 50
                 */
                OrderTrackingManager.SetTrackingRowToSigned(this, (int)OrderTypesEnum.InterimOrder, OrderEntryKey);
                OrderVerifiedSignedDate = DateTime.Now.Date;

                RaisePropertyChanged("OrderVerifiedSignedDate");
                RaisePropertyChanged("SigningPhysicianVerifiedBy");
                RaisePropertyChanged("SigningPhysicianVerifiedDate");
            }
            else
            {
                /* An order is marked as 'sent' when
                 *                      OrderVerifiedSignedDate is null
                 *                      SigningPhysicianVerifiedDate is null
                 *                      SigningPhysicianVerifiedBy is null
                 *                      OrderSent == true
                 *                      OrderSentDate.HasValue
                 *                      OrderStatus == 40 == (int)OrderStatusType.Completed
                 *                      this.OrdersTracking.Status == 40
                 */
                OrderVerifiedSignedDate = null;
                SigningPhysicianVerifiedDate = null;
                SigningPhysicianVerifiedBy = null;
                OrderStatus = (int)OrderStatusType.Completed;
                OrderSent = true;
                OrderSentDate = DateTime.Now.Date;

                // Revert OT to sent
                var myOT = OrdersTracking.FirstOrDefault();
                if (myOT != null)
                {
                    myOT.Status = (int)OrdersTrackingStatus.Sent;
                }
        ...
        {
            RaisePropertyChanged("CanEditOrderSignOrVerified");
        }
