...
namespace Virtuoso.Core.Services.MAR
{
    ...
    public class DataSetValidator
    {
        ...
        internal DataSetValidator(Patient patient, Encounter encounter)
        {
            Patient = patient;
            Encounter = encounter;
        }
        ...
        private bool CheckAnyCurrentMedicationsRequireMARMedicationTimes()
        {
            ...
            List<PatientMedication>
                pmViewSource =
                    utils.GetMARMedicationList(); // NOTE: MARCurrentPatientMedications are current meds - excluding future and discontinued
        ...
        private bool CheckAnyCurrentMedicationsRequireMARDocumentation()
        {
            ...
            foreach (PatientMedication pm in pmViewSource)
            {
                ...
                {
                    var validator = MARUtils.CreateMARValidator(Encounter, mar);
