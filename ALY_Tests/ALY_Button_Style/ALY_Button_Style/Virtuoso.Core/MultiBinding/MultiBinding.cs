...
namespace Virtuoso.Core.MultiBinding
{
    ...
    public class MultiBinding : DependencyObject, IMarkupExtension<Object>, ISupportInitialize
    {
        ...
        public bool NotifyOnValidationError
        {
            ...
            {
                CheckSealed();
                m_notifyOnValidationError = value;
            }
        }
        ...
        static MultiBinding()
        {
            ...
            for (int i = 0; i < MaxStyleMultiBindingsCount; i++)
                styleMultBindingProperties[i] = DependencyProperty.RegisterAttached("StyleMultiBinding" + i,
                    typeof(MultiBinding), typeof(MultiBinding), new PropertyMetadata(null, OnStyleMultiBindingChanged));
        }
        ...
        public static readonly DependencyProperty[] SourceProperties =
            { Source1Property, Source2Property, Source3Property, Source4Property, Source5Property };
    ...
    public class BindingCollection : Collection<Object>
    {
        ...
        public void CheckSealed()
        {
            ...
            {
                throw new InvalidOperationException(
                    "This BindingCollection cannot be changed when it has been sealed.");
            }
        }
