...
namespace Virtuoso.Core.Services
{
    ...
    public class DisciplineService : PagedModelBase, IDisciplineService
    {
        ...
        public bool SaveAllAsync()
        {
            ...
            Dispatcher.BeginInvoke(() =>
            {
                // Reload Context since changes to InsuranceAuthOrderTherapy
                // model were saved via UpdateInsuranceAuthOrderTherapyDto
                // and should not be submitted. See DisciplineViewModel.OKCommand.
                this.CancelInsuranceReqAuthOrderChanges();
