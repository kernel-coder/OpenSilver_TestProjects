namespace Virtuoso.Core.Utility
{
    ...
    /// <summary>
    /// Improves perfromance of sorting in CollectionView by using custom comparer instead of default comparer that uses reflection.
    /// It's beneficial for collections with more than 500 items.
    /// For example if DataGrid has 3000 rows, it reduces sorting time for 30-40%.
    /// </summary>
