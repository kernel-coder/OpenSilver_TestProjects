...
namespace Virtuoso.Core.Controls
{
    ...
    public interface IFilterInterfaceCore<E> where E : global::OpenRiaServices.DomainServices.Client.Entity
    {
        ...
        ObservableCollection<E> ItemsSource { get; set; }
        ...
        where E : VirtuosoEntity
    {
        ...
        public DetailUserControlBase()
        {
            ...
            IsOnline = true; // EntityManager.Current.IsOnlineCached; // EntityManager.Current.IsOnline;
        ...
        where E : VirtuosoEntity
    {
        ...
        {
            //if ((FilteredItemsSource != null) && (Encounter != null))
            //{
            //    //logWriter.Write(
        ...
        public static readonly DependencyProperty ItemsSourceProperty =
            DependencyProperty.Register("ItemsSource", typeof(ObservableCollection<E>), typeof(C),
        ...
        {
            //((ISelectedItem<E>)(sender)).SelectedItem = ((ObservableCollection<E>)(((C)(sender))
            //    .GetValue(ItemSourceProperty))).FirstOrDefault();

            try
            {
                var itemsSource = (ObservableCollection<E>)(((C)(sender)).GetValue(ItemsSourceProperty));
                var s = sender as ISelectedItem<E>;
                if (s != null)
                {
                    try
            ...
            //((C)(sender)).SelectedItem = ((ObservableCollection<E>)(((C)(sender))
            //    .GetValue(ItemSourceProperty))).FirstOrDefault();
        }
        ...
        public ObservableCollection<E> ItemsSource
        {
            get
            {
                return (ObservableCollection<E>)GetValue(ItemsSourceProperty);
            }
            set
            {
                if (ItemsSource != null)
        ...
        private void SetupCommands()
        {
            ...
            {
                bool? canExecute = true;// CanExecute_OK_CommandOverride();
                if (canExecute == null)
                {
            ...
            Cancel_Command = new RelayCommand(() =>
            {
                ...
                if (SelectedItem != null)
                {
                    ...
                    bool isNew = true; // (aw == null) ? ((SelectedItem == null) ? false : SelectedItem.IsNew) : aw.IsBrandNew;
        ...
        where E : VirtuosoEntity
    {
        ...
        public ListUserControlBase()
        {
            ...
            SetupCommands();
            CommandManager = new CommandManager(this);
            IsOnline = true; // EntityManager.Current.IsOnline;
        }
        ...
        public static readonly DependencyProperty ItemsSourceProperty =
            DependencyProperty.Register("ItemsSource", typeof(ObservableCollection<E>), typeof(C), //null);
        new PropertyMetadata(ItemsSourcePropertyChanged)); //Callback invoked on property value has changes
