...
{
    public partial class PatientPharmacyPopup : UserControl
    {
        public PatientPharmacyPopup()
        {
            InitializeComponent();
        }

        private void PatientPharmacy_BindingValidationError(object sender, ValidationErrorEventArgs e)
        {
