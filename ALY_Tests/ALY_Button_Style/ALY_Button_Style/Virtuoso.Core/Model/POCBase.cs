...
{
    public struct FaxingPhysician
    {
        public int PhysicianKey { get; set; }
        public string FaxNumber { get; set; }
    }

    public class POCBase : QuestionUI
    {
        ...
        public POCBase(Admission admission, Encounter encounter, int? formSectionQuestionKey) : base(
        ...
        {
            if ((EncounterAdmission == null) && (Question != null) && (Question.DataTemplate.Equals("POCPhysician") ||
                                                                       Question.DataTemplate.Equals(
                                                                           "POCHospicePhysician")))
            {
                ...
                if (EncounterAdmission == null)
                {
                    ...
                    EncounterAdmission.SigningPhysicianKey = OvrSignPhysicianKey;
                    SetEncounterAdmissionPhysicianAddressKey();
                }
            }

            if (EncounterAdmission != null && EncounterAdmission.SigningPhysicianKey != OvrSignPhysicianKey)
            {
                OvrSignPhysicianKey = EncounterAdmission.SigningPhysicianKey;
            }
        }

        public string GetPhysicianSignatureNarrative => EncounterPlanOfCare?.PhysicianSignatureNarrative;

        public string EPOCPhysicianSignatureNarrative
        {
            get { return EncounterPlanOfCare?.PhysicianSignatureNarrative; }
        ...
        private void SetupSelectedAdmissionPhysician()
        {
            ...
            if (ea != null && ea.SigningPhysicianKey.HasValue)
            {
                if (AdmissionPhysicianList != null)
                {
                    ...
                    if (myList != null)
                    {
                        SelectedAdmissionPhysician = myList.FirstOrDefault(ap => ap.PhysicianKey == ea.SigningPhysicianKey);
                    }
                }
            }
            ...
            if (SelectedAdmissionPhysician == null)
            {
                ...
                SelectedAdmissionPhysician = AdmissionPhysician.SigningAdmissionPhysician;
            }
        }
        ...
        private void RaiseSignedInformationPropertyChanged()
        {
            ...
            RaisePropertyChanged("OvrSignPhysicianKey");
        }

        public int? OvrSignPhysicianKey
        {
            get
            {
                return AdmissionPhysician.OverrideSigningPhysicianKey ?? AdmissionPhysician.SigningPhysicianKey;
            }
            set
            {
                AdmissionPhysician.OverrideSigningPhysicianKey = value;
                SetEncounterAdmissionPhysicianKey(value);
                SetupSigningMedicalDirector();
                Messenger.Default.Send(value, string.Format("OverrideSigningPhysicianKeyChanged{0}", Encounter.EncounterKey.ToString().Trim()));
            }
        }
        ...
        private void SetEncounterAdmissionPhysicianKey(int? PhyKey)
        {
            ...
            if (ea.SigningPhysicianKey != PhyKey)
            {
                ea.SigningPhysicianKey = PhyKey;
            }
        }
        ...
        public void SetEncounterAdmissionPreviousPhysicianKey()
        {
            ...
            ea.PreviousSigningPhysicianKey = ea.SigningPhysicianKey;
        }
        ...
        public String SignPhyAddress1
        {
            get
            {
                ...
                if (SelectedAdmissionPhysician == null)
                {
                    if (AdmissionPhysician.SigningPhysician.MainAddress == null)
                    {
                        return null;
                    }

                    return AdmissionPhysician.SigningPhysician.MainAddress.Address1;
                }
        ...
        public String SignPhyAddress2
        {
            get
            {
                ...
                if (SelectedAdmissionPhysician == null)
                {
                    ...
                    return AdmissionPhysician.SigningPhysician.MainAddress.Address2;
                }
        ...
        public String SignPhyCityStateZip
        {
            get
            {
                ...
                if (SelectedAdmissionPhysician == null)
                {
                    ...
                    return AdmissionPhysician.SigningPhysician.MainAddress.CityStateZip;
                }
        ...
        public String SignPhyPhoneNumber
        {
            get
            {
                ...
                if (SelectedAdmissionPhysician == null)
                {
                    if (AdmissionPhysician.SigningPhysician.MainPhone == null)
                    {
                        return null;
                    }

                    return AdmissionPhysician.SigningPhysician.MainPhone.Number;
                }
        ...
        public String SignPhyFaxNumber
        {
            get
            {
                // NOTE: if you change the logic for where the SignPhyFaxNumber is found - update GetFaxingPhysician()
                ...
                if (SelectedAdmissionPhysician == null)
                {
                    var FaxRow = AdmissionPhysician.SigningPhysician.GetPhoneByType("FAX");
        ...
        {
            // NOTE: HomeHealth uses SigningPhysician (Hospice uses AttendingPhysician)
            if (SelectedAdmissionPhysician != null)
            {
        ...
        {
            if ((CurrentEncounterPlanOfCare == null) || (Question == null) || (Question.DataTemplate.Equals("POCHospicePhysician") == false))
            {
                return;
            }
            ...
            {
                AdmissionPhysician apMedicalDirector = AdmissionPhysician.ActiveAdmissionPhysicians
                    .FirstOrDefault(p => ((p.PhysicianKey != OvrSignPhysicianKey) && (p.PhysicianType == CodeLookupCache.GetKeyFromCode("PHTP", "MedDirect"))));
        ...
        public bool ShowMedicalDirector
        {
            get
            {
                if ((Question == null) || (Question.DataTemplate.Equals("POCHospicePhysician") == false))
                {
                    return false;
                }
                ...
                if ((OvrSignPhysicianKey == null) || (AdmissionPhysician.ActiveAdmissionPhysicians == null))
                {
                    return false;
                }

                if (AdmissionPhysician.ActiveAdmissionPhysicians.Any(p => ((p.PhysicianKey == OvrSignPhysicianKey) 
        ...
        public bool ProtectedVerbalSOC
        {
            get
            {
                if ((Encounter == null) || (EncounterPlanOfCare == null))
                {
                    return true;
                }
        ...
        public override bool Validate(out string SubSections)
        {
            ...
            else if ((Question.DataTemplate.Equals("POCPhysician")) ||
                     (Question.DataTemplate.Equals("POCHospicePhysician")))
            {
                ...
                EncounterAdmission.SigningPhysicianKey = OvrSignPhysicianKey;
                if (AdmissionPhysician.SigningPhysicianKey == null)
                {
                    Encounter.ValidationErrors.Add(new ValidationResult("Signing Physician is required",
                        new[] { "OvrSignPhysicianKey", "SigningPhysicianKey" }));
                    return false;
                }

                if ((Question.DataTemplate.Equals("POCHospicePhysician")) && ShowMedicalDirector)
                {
                    EncounterPlanOfCare ep = (Encounter.EncounterPlanOfCare == null)
                        ? null
                        : Encounter.EncounterPlanOfCare.FirstOrDefault();
                    if ((ep != null) && (ep.SigningMedicalDirectorKey == null))
                    {
                        ep.ValidationErrors.Add(new ValidationResult(
                            "Signing Medical Director / Hospice Physician is required",
                            new[] { "SigningMedicalDirectorKey" }));
                        return false;
                    }
                }
    ...
    public class POCBaseFactory
    {
            ...
            int pqgkey, int qgkey, int sequence, bool copyforward, Question q)
        {
            ...
            POCBase pm = new POCBase(vm.CurrentAdmission, vm.CurrentEncounter, __FormSectionQuestionKey)
            {
